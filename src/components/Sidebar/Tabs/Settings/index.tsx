...
const LABEL_GROUPS: LabelGroup[] = [
  ...
  },
  {
    ...
    keys: [
      ...
      { key: "um_actions_col_action",  desc: "عمود الإجراء في سجل الإجراءات" },
      { key: "um_actions_col_target",  desc: "عمود الهدف في سجل الإجراءات" },
      { key: "um_actions_col_month",   desc: "عمود الشهر في سجل الإجراءات" },
      { key: "um_actions_col_details", desc: "عمود التفاصيل في سجل الإجراءات" },
      { key: "um_action_type_user_deleted",               desc: "تسمية إجراء: حذف مستخدم" },
      { key: "um_action_type_user_created",               desc: "تسمية إجراء: إنشاء مستخدم" },
      { key: "um_action_type_permission_changed",         desc: "تسمية إجراء: تغيير صلاحية صفحة" },
      { key: "um_action_type_feature_permission_changed", desc: "تسمية إجراء: تغيير صلاحية ميزة" },
      { key: "um_action_type_sample_drawn",                desc: "تسمية إجراء: سحب عينة" },
      { key: "um_action_type_distribution_bulk_assigned", desc: "تسمية إجراء: توزيع جماعي" },
      { key: "um_action_type_referral_approved",          desc: "تسمية إجراء: اعتماد إحالة" },
      { key: "um_action_type_referral_denied",            desc: "تسمية إجراء: رفض إحالة" },
      { key: "um_action_type_replacement_approved",       desc: "تسمية إجراء: اعتماد استبدال" },
      { key: "um_action_type_replacement_denied",         desc: "تسمية إجراء: رفض استبدال" },
      { key: "um_action_type_reopen_approved",            desc: "تسمية إجراء: اعتماد إعادة فتح" },
      { key: "um_action_type_reopen_denied",              desc: "تسمية إجراء: رفض إعادة فتح" },
      { key: "um_action_type_answer_reopened",            desc: "تسمية إجراء: إعادة فتح إجابة" },
      { key: "um_action_type_month_closed",               desc: "تسمية إجراء: إقفال شهر" },
      { key: "um_action_type_month_reopened",             desc: "تسمية إجراء: إعادة فتح شهر" },
      { key: "um_action_type_backup_restored",            desc: "تسمية إجراء: استرجاع نسخة احتياطية" },
    ],
  },
];
