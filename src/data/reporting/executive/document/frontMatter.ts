...
// Official ZATCA logo, embedded as a data URI (VIS-05) so the standalone report
// renders the mark offline; the inline-SVG fallback stays as a second net.
const ZATCA_LOGO = `<span class="zatca-logo" style="display:inline-flex;align-items:center;justify-content:center;width:64px;height:64px">
  <img src="${ZATCA_LOGO_URL}" alt="هيئة الزكاة والضريبة والجمارك" width="64" height="64" style="width:64px;height:64px;object-fit:contain;filter:brightness(0) invert(1)" onerror="this.style.display='none';this.nextElementSibling.style.display='block';"/>
