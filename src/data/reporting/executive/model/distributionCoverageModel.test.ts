// Data-correctness tests for the distribution coverage model (relocated from
// distributionReport.test.ts, 2026-08-27 — Task 2 of the population/report
// merge plan). computeDistributionModel is consumed by the Executive report
// family independently of the standalone "تقرير التوزيع" builder.
