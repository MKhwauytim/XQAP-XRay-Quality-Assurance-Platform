...
export const DEFAULT_LABELS = {
  ...
  firstrun_demo_hint:                "لتجربة النظام ببيانات وهمية: من شاشة اختيار مساحة العمل اختر «الدخول التجريبي» وسجّل الدخول بالحساب demo / demo.",
  ...
  wsgate_view_passcode_error:  "بيانات الدخول غير صحيحة.",
  ...
  wsgate_view_modal_title:     "الدخول التجريبي",
  wsgate_view_modal_desc:      "سجّل الدخول بالحساب التجريبي (demo / demo) لاستكشاف النظام كاملاً ببيانات وهمية — دون اختيار مجلد ودون حفظ أي شيء على الجهاز.",
  wsgate_demo_btn:             "الدخول التجريبي",
  wsgate_demo_username_label:  "اسم المستخدم",
