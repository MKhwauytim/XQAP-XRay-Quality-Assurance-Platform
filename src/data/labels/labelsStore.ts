...
export const DEFAULT_LABELS = {
  ...
  toolbar_mode_demo:          "الوضع التجريبي",
  ...
  toolbar_debug_toggle_show:  "Show Debug Tools",
  toolbar_debug_toggle_hide:  "Hide Debug Tools",
  toolbar_debug_export_btn:   "Export Debug Report",
  toolbar_debug_exporting:    "Exporting...",
  ...
  firstrun_demo_hint:                "لتجربة النظام ببيانات وهمية: من شاشة اختيار العنوان اختر «الدخول بنمط التجربة» وأدخل كلمة المرور demo.",

  // ── App shell — C6 (Batch 2) label coverage audit ──
  app_demo_banner:           "الوضع التجريبي — بيانات وهمية في الذاكرة: كل التعديلات تعمل فعلياً لكنها لا تُحفظ على الجهاز وتزول عند تسجيل الخروج",
  app_bak_recovered_warning: "تعذّرت قراءة النسخة الأصلية من الملف \"{fileName}\"، وتم عرضه من النسخة \"{source}\" — قد تكون البيانات غير مكتملة. النسخة الأصلية لا تزال تالفة وسيتكرر هذا التنبيه حتى تُعاد كتابتها؛ يُرجى إبلاغ مسؤول النظام باسم الملف.",
  ...
  wsgate_view_passcode_error:  "كلمة المرور غير صحيحة.",
  ...
  integrity_boot_title:            "فحص سلامة الملفات عند الدخول",
  integrity_boot_summary_repaired: "تم إصلاح {count} من الملفات تلقائياً.",
  integrity_boot_summary_attention:"{count} من العناصر تحتاج إلى مراجعتك.",
  integrity_boot_none:             "لم يُعثر على أي مشكلة في ملفات مساحة العمل.",
  integrity_boot_group_repaired:   "أُصلحت تلقائياً",
  integrity_boot_group_attention:  "تحتاج إلى مراجعة",
  integrity_boot_problem_damaged:  "ملف تالف",
  integrity_boot_problem_orphan:   "نسخة احتياطية بلا ملف أصلي",
  integrity_boot_problem_missing:  "مجلد مفقود",
  integrity_boot_outcome_checkfail:"تعذّر الفحص",
  integrity_boot_archive_note:     "لم يُحذف أي ملف — احتُفظ بالنسخة الأصلية في المجلد نفسه.",
  integrity_boot_restore_note:     "استُرجع الملف من نسخة احتياطية، وقد لا تتضمن آخر تعديل.",
  integrity_boot_dismiss:          "إغلاق",
  wsgate_picker_denied_hint:   "المتصفح يحظر الوصول إلى المجلدات لهذا الموقع. افتح إعدادات الموقع في المتصفح («تعديل الملفات» / chrome://settings/content/filesystem)، اسمح بالوصول، ثم أعد تحميل الصفحة.",
  wsgate_reconnect_btn:        "إعادة الاتصال بمساحة العمل",
  wsgate_pick_folder_btn:      "اختيار مجلد",
  wsgate_view_modal_title:     "الدخول بنمط التجربة",
  wsgate_view_modal_desc:      "أدخل كلمة المرور demo لاستكشاف النظام كاملاً ببيانات وهمية — دون اختيار عنوان ودون حفظ أي شيء على الجهاز.",
  wsgate_demo_btn:             "الدخول بنمط التجربة",
  wsgate_demo_password_label:  "كلمة المرور",
  ...
  // Display labels for WorkspaceActionType (src/data/audit/actionLog.ts).
  // `actionCatalog.ts` maps every union member to exactly one key here and a
  // test walks the whole union, so a type added without its key fails the suite
  // rather than rendering the raw English id to an Arabic-only user.
  um_action_type_user_deleted:               "حذف مستخدم",
  um_action_type_user_created:               "إنشاء مستخدم",
  um_action_type_user_updated:               "تعديل بيانات مستخدم",
  um_action_type_user_password_reset:        "إعادة تعيين كلمة مرور",
  um_action_type_permission_changed:         "تغيير صلاحية صفحة",
  um_action_type_feature_permission_changed: "تغيير صلاحية ميزة",
  um_action_type_population_saved:           "حفظ المجتمع على القرص",
  um_action_type_sample_drawn:               "سحب عينة",
  um_action_type_distribution_bulk_assigned: "توزيع جماعي",
  um_action_type_distribution_row_changed:   "تعديل تعيين صف",
  ...
  um_action_type_replacement_requested:      "طلب استبدال",
  um_action_type_replacement_applied:        "تنفيذ استبدال مباشر",
  um_action_type_replacement_approved:       "اعتماد استبدال",
  um_action_type_replacement_denied:         "رفض استبدال",
  um_action_type_reopen_requested:           "طلب إعادة فتح",
  ...
  um_action_type_answer_submitted:           "تقديم إجابة",
  ...
  um_action_type_adhoc_import_closed:        "إقفال استيراد استثنائي",
  um_action_type_adhoc_import_reopened:      "إعادة فتح استيراد استثنائي",
  um_action_type_template_created:           "إنشاء نموذج فحص",
  um_action_type_template_updated:           "تعديل نموذج فحص",
  um_action_type_template_deleted:           "حذف نموذج فحص",
  um_action_type_inspection_template_selected: "تغيير نموذج الفحص المعتمد",
  um_action_type_notification_posted:        "نشر تنبيه",
  um_action_type_notification_edited:        "تعديل تنبيه",
  um_action_type_notification_deleted:       "حذف تنبيه",
  um_action_type_notification_restored:      "استرجاع تنبيه محذوف",
  um_action_type_month_closed:               "إقفال شهر",
  um_action_type_month_reopened:             "إعادة فتح شهر",
  um_action_type_backup_created:             "إنشاء نسخة احتياطية",
  um_action_type_backup_restored:            "استرجاع نسخة احتياطية",
  um_action_type_backup_settings_changed:    "تغيير إعدادات النسخ الاحتياطي",
  um_action_type_label_override_changed:     "تعديل تسميات الواجهة",
  um_action_type_sync_interval_changed:      "تغيير فترة المزامنة",
  um_action_type_admin_account_changed:      "تعديل حساب المدير",
  um_action_type_report_generated:           "توليد تقرير أو تصدير",

  // ── Actions viewer — filter bar ──
  um_actions_group_users:         "المستخدمون والصلاحيات",
  ...
  um_actions_group_system:        "النظام والنسخ الاحتياطي والإعدادات",
  um_actions_filters_title:       "تصفية السجل",
  um_actions_filter_types:        "نوع الإجراء",
  um_actions_filter_actor:        "المستخدم",
  um_actions_filter_actor_all:    "كل المستخدمين",
  um_actions_filter_from:         "من تاريخ",
  um_actions_filter_to:           "إلى تاريخ",
  um_actions_filter_search:       "بحث في الهدف والتفاصيل",
  um_actions_filter_search_ph:    "رقم العينة، اسم موظف، أي نص في التفاصيل...",
  um_actions_filter_reset:        "إعادة ضبط التصفية",
  um_actions_filter_select_all:   "تحديد الكل",
  um_actions_filter_select_none:  "إلغاء تحديد الكل",
  um_actions_filter_high_volume_hint: "أنواع عالية العدد — غير مُفعّلة افتراضياً.",
  um_actions_filter_active:       "التصفية مُفعّلة",
  um_actions_count_filtered:      "{shown} من {total}",
  um_actions_no_match:            "لا توجد سجلات مطابقة للتصفية الحالية.",
  ...
  um_perf_range_label:          "الفترة المعروضة: {range}",
  um_perf_range_full:           "كل البيانات المتاحة",
  um_perf_range_start_fallback: "بداية البيانات",
  um_perf_range_end_fallback:   "اليوم",
  ...
  // Employee comparison table — the تقييم الأداء centerpiece (replaces the flat KPI-card grid)
  um_perf_compare_title:        "مقارنة الموظفين",
  um_perf_compare_empty:        "لا توجد بيانات كافية لعرض مقارنة الموظفين ضمن الفترة المحددة.",
  um_perf_compare_team_avg:     "متوسط الفريق: {avg} عينة/موظف",
  um_perf_compare_team_pace:    "الوسيط الزمني للفريق: {pace}",
  um_perf_compare_col_rank:     "#",
  um_perf_compare_col_gaps:     "توزيع الفجوات",
  um_perf_compare_col_status:   "الحالة",
  um_perf_compare_last_active:  "آخر نشاط: {day}",
  um_perf_compare_gap_caption:  "{count} فجوة متوسطة/كبيرة من {total}",
  um_perf_compare_legend_note:  "الشريط لكل موظف يوضّح نسبة كل نوع فجوة من إجمالي فجواته، مقارنة بوسيطه الزمني الشهري الخاص.",
  um_perf_status_above:         "أعلى من المعدل",
  um_perf_status_within:        "ضمن المعدل",
  um_perf_status_below:         "أدنى من المعدل",
  um_perf_status_frequent_large_suffix: "فجوات كبيرة متكررة",

  um_perf_trend_title:          "العينات المُنجزة يومياً",
  um_perf_trend_empty:          "لا توجد عينات مُنجزة ضمن الفترة المحددة.",
  um_perf_trend_avg_label:      "المتوسط اليومي: {avg} عينة",
  um_perf_trend_scope_team:     "إجمالي عينات الفريق يومياً",
  um_perf_trend_scope_employee: "عينات {name} يومياً",
  ...
  um_perf_gaps_desc:            "فترة توقف بين تسجيل الدخول وأول عينة، أو بين عينتين متتاليتين. يُصنَّف كل تصنيف نسبةً إلى الوسيط الزمني الشهري لنفس الموظف — لا يوجد مقياس ثابت مشترك بين الموظفين.",
  ...
  um_perf_tier_legend_normal:   "طبيعية — ضمن +5 د عن وسيطه",
  um_perf_tier_legend_small:    "صغيرة — حتى +20 د",
  um_perf_tier_legend_medium:   "متوسطة — حتى +60 د",
  um_perf_tier_legend_large:    "كبيرة — أكثر من +60 د",
  um_perf_tier_legend_unclassified: "غير مصنّفة — بيانات الشهر غير كافية بعد",
  ...
  /* ── إصلاح ملفات قرارات الاعتماد (Settings → DecisionRepairSection) ─────── */
  decision_repair_title:            "إصلاح ملفات قرارات الاعتماد",
  decision_repair_hint:             "يفحص ملفات قرارات المشرفين في الشهر المحدد ويكشف أي ملف تالف يمنع تسجيل قرارات الاعتماد. لا يُحذف أي ملف نهائياً — تُؤرشف النسخة التالفة دائماً قبل أي إصلاح.",
  decision_repair_month_label:      "الشهر",
  decision_repair_scan_btn:         "فحص ملفات الشهر",
  decision_repair_scanning:         "جاري الفحص...",
  decision_repair_none:             "لا توجد ملفات قرارات في هذا الشهر.",
  decision_repair_all_ok:           "جميع ملفات القرارات في هذا الشهر سليمة.",
  decision_repair_col_supervisor:   "المشرف",
  decision_repair_col_state:        "الحالة",
  decision_repair_col_action:       "الإجراء",
  decision_repair_state_ok:         "سليم ({count} قرار)",
  decision_repair_state_absent:     "لا توجد قرارات بعد",
  decision_repair_state_blocked:    "تالف — يمنع تسجيل أي قرار اعتماد",
  decision_repair_state_covered:    "تالف — تغطيه نسخة احتياطية مؤقتاً",
  decision_repair_state_unavailable: "تعذّر الوصول إلى الملف حالياً",
  decision_repair_chain_break:      "تسلسل التحقق مكسور ابتداءً من القرار رقم {index}",
  decision_repair_restore_btn:      "استعادة من النسخة الاحتياطية",
  decision_repair_reset_btn:        "أرشفة الملف وبدء سجل جديد",
  decision_repair_reset_confirm_title: "أرشفة ملف القرارات وبدء سجل جديد؟",
  decision_repair_reset_confirm_body:  "لا توجد أي نسخة قابلة للقراءة من هذا الملف. ستُؤرشف النسخة التالفة (ولن تُحذف)، ويبدأ سجل قرارات فارغ لهذا المشرف في هذا الشهر. القرارات السابقة المسجّلة في الملف التالف لن تظهر في التطبيق بعد ذلك.",
  decision_repair_restored:         "تمت الاستعادة: {count} قرار من النسخة {source}. حُفظت النسخة التالفة باسم {archived}. قد لا تشمل الاستعادة آخر قرار سُجّل قبل التلف.",
  decision_repair_reset_done:       "بدأ سجل قرارات جديد. حُفظت النسخة التالفة باسم {archived}.",
  decision_repair_unrecoverable:    "لا توجد نسخة قابلة للقراءة. استخدم «أرشفة الملف وبدء سجل جديد» إذا كنت تقبل فقدان القرارات السابقة.",
  decision_repair_unavailable:      "تعذّر الوصول إلى المجلد المشترك، ولم يُغيَّر أي ملف. أعد المحاولة عندما يستقر الاتصال — الملف على الأرجح سليم.",
  decision_repair_unsupported:      "لا تسمح صلاحية مجلد العمل الحالية بحذف الملفات، فتعذّرت الأرشفة.",
  decision_repair_failed:           "تعذّر الإصلاح: {error}",
  decision_repair_scan_failed:      "تعذّر فحص ملفات القرارات: {error}",

  /* ── إصلاح ملفات القوالب (Settings → TemplateRepairSection) ─────────────── */
  template_repair_title:            "إصلاح ملفات القوالب",
  template_repair_hint:             "يفحص كل ملفات القوالب في مجلد العمل ويكشف أي ملف تالف يظهر تنبيه «تعذّرت قراءة النسخة الأصلية». لا يُحذف أي ملف نهائياً — تُؤرشف النسخة التالفة دائماً قبل أي إصلاح.",
  template_repair_scan_btn:         "فحص ملفات القوالب",
  template_repair_scanning:         "جاري الفحص...",
  template_repair_none:             "لا توجد ملفات قوالب في مجلد العمل.",
  template_repair_all_ok:           "جميع ملفات القوالب سليمة.",
  template_repair_col_template:     "القالب",
  template_repair_col_state:        "الحالة",
  template_repair_col_action:       "الإجراء",
  template_repair_state_ok:         "سليم — {name} ({count} حقل)",
  template_repair_state_absent:     "غير موجود",
  template_repair_state_covered:    "تالف — تغطيه نسخة احتياطية مؤقتاً، وسيتكرر التنبيه حتى الإصلاح",
  template_repair_state_unavailable: "تعذّر الوصول إلى الملف حالياً",
  template_repair_restore_btn:      "استعادة من النسخة الاحتياطية",
  template_repair_restored:         "تمت الاستعادة من النسخة {source}. حُفظت النسخة التالفة باسم {archived}. قد لا تشمل الاستعادة آخر تعديل قبل التلف.",
  template_repair_unrecoverable:    "لا توجد نسخة قابلة للقراءة من هذا القالب. افتح القالب في منشئ القوالب وأعد حفظه إذا كانت بياناته الحالية صحيحة، أو أعد إنشاءه.",
  template_repair_unavailable:      "تعذّر الوصول إلى المجلد المشترك، ولم يُغيَّر أي ملف. أعد المحاولة عندما يستقر الاتصال — الملف على الأرجح سليم.",
  ...
  // ── Admin debug tools panel (AdminToolbar toggle, real admin sessions only) ─
  demo_debug_panel_title:        "Admin Debug Tools",
  demo_debug_close:              "Close",
  demo_debug_section_connection: "Connection",
  demo_debug_online:             "Online",
  demo_debug_offline:            "Offline",
  demo_debug_effective_type:     "Connection type",
  demo_debug_downlink:           "Downlink",
  demo_debug_rtt:                "RTT",
  demo_debug_connection_unavailable: "Connection info unavailable in this browser",
  demo_debug_section_sync:       "Sync",
  demo_debug_sync_interval:      "Auto interval",
  demo_debug_last_sync:          "Last sync attempt",
  demo_debug_last_sync_never:    "Not run yet",
  demo_debug_manual_syncs:       "Manual refreshes",
  demo_debug_last_manual_duration: "Last manual refresh duration",
  demo_debug_ok:                 "OK",
  demo_debug_failed:             "Failed",
  demo_debug_section_responsiveness: "UI Responsiveness",
  demo_debug_frame_avg:          "Avg frame time",
  demo_debug_frame_max:          "Max",
  demo_debug_click_avg:          "Avg click latency",
  demo_debug_samples_count:      "Samples",
  demo_debug_section_memory:     "Memory & Storage",
  demo_debug_memory_usage:       "Memory usage",
  demo_debug_storage_usage:      "Storage used",
  demo_debug_unavailable:        "Unavailable",
  demo_debug_section_errors:     "Recent Errors",
  demo_debug_no_errors:          "No errors recorded.",
  demo_debug_export_btn:         "Export Full Report",
  demo_debug_exporting:          "Exporting...",
