...
export const DEFAULT_LABELS = {
  ...
  toolbar_debug_toggle_show:  "إظهار أدوات التصحيح",
  toolbar_debug_toggle_hide:  "إخفاء أدوات التصحيح",
  toolbar_debug_export_btn:   "تصدير تقرير التصحيح",
  toolbar_debug_exporting:    "جارٍ التصدير...",
  ...
  demo_debug_panel_title:        "أدوات تصحيح الوضع التجريبي",
  demo_debug_close:              "إغلاق",
  demo_debug_section_connection: "الاتصال",
  demo_debug_online:             "متصل",
  demo_debug_offline:            "غير متصل",
  demo_debug_effective_type:     "نوع الاتصال",
  demo_debug_downlink:           "سرعة التنزيل",
  demo_debug_rtt:                "زمن الاستجابة (RTT)",
  demo_debug_connection_unavailable: "معلومات الاتصال غير متاحة في هذا المتصفح",
  demo_debug_section_sync:       "المزامنة",
  demo_debug_sync_interval:      "الفاصل التلقائي",
  demo_debug_last_sync:          "آخر محاولة مزامنة",
  demo_debug_last_sync_never:    "لم تُنفَّذ بعد",
  demo_debug_manual_syncs:       "عدد التحديثات اليدوية",
  demo_debug_last_manual_duration: "مدة آخر تحديث يدوي",
  demo_debug_ok:                 "ناجح",
  demo_debug_failed:             "فاشل",
  demo_debug_section_responsiveness: "استجابة الواجهة",
  demo_debug_frame_avg:          "متوسط زمن الإطار",
  demo_debug_frame_max:          "الأعلى",
  demo_debug_click_avg:          "متوسط زمن استجابة النقر",
  demo_debug_samples_count:      "عدد العينات",
  demo_debug_section_memory:     "الذاكرة والتخزين",
  demo_debug_memory_usage:       "استخدام الذاكرة",
  demo_debug_storage_usage:      "التخزين المستخدم",
  demo_debug_unavailable:        "غير متاح",
  demo_debug_section_errors:     "الأخطاء الأخيرة",
