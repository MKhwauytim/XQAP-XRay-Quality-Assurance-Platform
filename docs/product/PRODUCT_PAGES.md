# Product Pages — Full Description (2026-07-13)
...
- **مركز الإشعارات (Notification Manager):** admin/manager broadcast announcements with per-user acceptance tracking.
...
### 3. Reports (`reports`, guest/supervisor/manager/admin)
...
### 4. Archive (`archive`, guest/supervisor/manager/admin)
...
### 5. User Management (`user-management`, admin)
...
### 6. Settings (`settings`, guest/admin)
